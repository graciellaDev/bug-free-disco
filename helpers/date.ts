...
export const convertDateFromApi = (dateString: string | null | undefined): string | null => {
...
export const convertDateToApi = (dateString: string | null | undefined): string | null => {
    if (!dateString) return null;
